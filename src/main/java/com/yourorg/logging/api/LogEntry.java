...
public final class LogEntry {
    ...
    public static final class Builder {
        ...
        private long timestamp = Instant.now().toEpochMilli();   // ✅ store as long
        ...
        public Builder timestamp(long millis) { this.timestamp = millis; return this; }
        public Builder timestamp(Instant instant) { this.timestamp = instant.toEpochMilli(); return this; }
    ...
    public long getTimestamp() { return timestamp; }       // ✅ long getter
    @JsonIgnore
    public Instant getTimestampAsInstant() { return Instant.ofEpochMilli(timestamp); }
